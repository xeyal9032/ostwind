    ...
    const fetchPlan = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setLocaleValues({
            name: mergeLocaleJson(data.name),
            features: mergeLocaleJson(data.features),
          });
        } else {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Fiyat Planını Düzenle</h1>
        <Link
          href="/admin/pricing"
